...
$$v_{rel_P}' = (v_{p_B}' - v_{p_A}') \cdot n = -e \cdot v_{rel_P} \qquad (12)$$
...
$$
\begin{align}
v_{rel_P}' &= \left(v_{p_B} + j \left(\frac{n}{m_B} + \frac{(r_B \times n) \times r_B}{I_B}\right) - v_{p_A} - (-j) \left(\frac{n}{m_A} + \frac{(r_A \times n) \times r_A}{I_A}\right)\right) \cdot n \qquad (13.1)\\
&= \underbrace{(v_{p_B} - v_{p_A}) \cdot n}_{v_{rel_P}} + j \left(\frac{1}{m_A} + \frac{1}{m_B} + \frac{((r_A \times n) \times r_A) \cdot n}{I_A} + \frac{((r_B \times n) \times r_B) \cdot n}{I_B}\right) \qquad(13.2) \\
&= v_{rel_P} + j \left(\frac{1}{m_A} + \frac{1}{m_B} + \frac{(r_A \times n)^2}{I_A} + \frac{(r_B \times n)^2}{I_B}\right) \qquad(13.3)
\end{align}
$$
