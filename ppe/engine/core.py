...
class Body:
    ...
    def __init__(self, shape: "Shape", position: Vec2, mass: float, restitution: float = 0.2, static: bool = False):
        self.shape = shape
        ...
        if static or mass == 0:
            ...
            self.inverse_inertia: float = 1.0 / self.shape.calculate_inertia(mass) if self.shape else 0.0
...
class Contact:
    ...
    def __init__(self, body_a: Body, body_b: Body, normal: Vec2, penetration_depth: float):
        self.body_a = body_a
        self.body_b = body_b
        self.normal = normal
...
class DistanceJoint:
    ...
    def __init__(self, body_a: Body, body_b: Body, anchor_a: Vec2, anchor_b: Vec2, distance: float):
        self.body_a = body_a
        self.body_b = body_b
